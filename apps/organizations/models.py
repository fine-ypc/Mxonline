...
class City(BaseModel):
    ...
    def __str__(self):  # 定义系统输出(创建)本字段时的名称
        return self.name
...
class Teacher(BaseModel):
    ...
    work_company = models.CharField(default=0, max_length=20, verbose_name="就职公司")
    work_position = models.CharField(default=0, max_length=20, verbose_name="公司职位")
